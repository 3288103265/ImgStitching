...
def compute_spherical_warp_mappings(dstShape, f, k1, k2):
    '''
...
def warp_spherical(image, focalLength, k1=-0.21, k2=0.26):
    '''
    Input:
    ...
    # source image
    uv = compute_spherical_warp_mappings(np.array(image.shape), focalLength, k1, \
                                         k2)

    # warp image based on backwards coordinates
    return warp_local(image, uv)
